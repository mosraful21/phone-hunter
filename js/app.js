...
document.getElementById('search-felid').addEventListener('keypress', function(e){
    if(e.key === 'Enter') {
        processSearch(10);
    }
})
...
const displayPhoneDetails = (phone) => {
    ...
    phoneDetails.innerHTML = `
        ...
        <p>Others: ${phone.others ? phone.others.Bluetooth : "No Others found"}</p>
        <p>Sensor: ${phone.mainFeatures ? phone.mainFeatures.sensors[1] : "No sensor"}</p>
    `
}
